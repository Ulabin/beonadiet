...
public class MyOwnSaladController {
    ...
    public String MyOwnSaladStep2Post(Model model, @RequestParam("my_own_series") String myOwnSeriesInfo){
        List<MyOwnSaladProteinDTO> dtolist= proteinService.findAllProtein();
        model.addAttribute("list", dtolist);
    ...
    public String MyOwnSaladStep3Post(Model model,@RequestParam("my_own_series") String myOwnSeriesInfo){
        List<MyOwnSaladToppingDTO> dtolist= toppingService.findAllTopping();
        model.addAttribute("list", dtolist);
        model.addAttribute("myOwnSeriesInfo", myOwnSeriesInfo);
        return "my_own_series/salad/my_own_salad_step3";
    ...
    public String MyOwnSaladStep4Post(Model model,@RequestParam("my_own_series") String myOwnSeriesInfo){
        List<MyOwnSaladCarbsDTO> dtolist= carbsService.findAllCarbs();
        model.addAttribute("list", dtolist);
        model.addAttribute("myOwnSeriesInfo", myOwnSeriesInfo);
        return "my_own_series/salad/my_own_salad_step4";
    ...
    public String MyOwnSaladStep5Post(Model model,@RequestParam("my_own_series") String myOwnSeriesInfo){
        List<MyOwnSaladSauceDTO> dtolist= sauceService.findAllSauce();
        model.addAttribute("list", dtolist);
        model.addAttribute("myOwnSeriesInfo", myOwnSeriesInfo);
        return "my_own_series/salad/my_own_salad_step5";
    ...
    public String MyOwnSaladFinalPost(Model model,@RequestParam("my_own_series") String myOwnSeriesInfo){
        model.addAttribute("myOwnSeriesInfo", myOwnSeriesInfo);
        return "my_own_series/salad/my_own_salad_final";
    }
}
